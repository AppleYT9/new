...
import { SafetyPreferencesStep } from "./booking-steps/safety-preferences-step"
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="mb-8 text-center">
                        <h1 className="mb-2 text-3xl font-bold text-balance"><TranslatedText text="Book Your Accessible Ride" /></h1>
                        <p className="text-muted-foreground"><TranslatedText text="Complete the steps below to book your ride" /></p>
                    </div>
