        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <Badge className="bg-primary text-primary-foreground">Ride #{rideId}</Badge>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="lg:col-span-2 space-y-6">
              <Card className="rounded-2xl shadow-sm overflow-hidden">
                <div className="aspect-video bg-muted flex items-center justify-center relative">
                  ...
                  <div className="relative text-center">
                    ...
                    <p className="text-lg font-semibold mb-1">Live GPS Tracking</p>
              ...
              <Card className="p-6 rounded-2xl shadow-sm">
                <h2 className="mb-4 text-lg font-bold">Journey Details</h2>
              ...
              <Card className="p-6 rounded-2xl shadow-sm bg-primary/5 border-primary/20">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Accessibility Features</h3>
            ...
            <div className="space-y-6">
              <Card className="p-6 rounded-2xl shadow-sm">
                <h2 className="mb-4 text-lg font-bold">Your Driver</h2>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
              ...
              <Card className="p-6 rounded-2xl shadow-sm">
                <h2 className="mb-4 text-lg font-bold">Safety & Support</h2>
              ...
              <Card className="p-4 rounded-2xl shadow-sm bg-accent/5 border-accent/20">
                <p className="text-sm text-foreground leading-relaxed">
                  <span className="font-medium">Safety First:</span> Your ride is being tracked in real-time and can be
        ...
        <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-center p-4">
          <Card className="max-w-md w-full p-6 rounded-2xl shadow-lg">
            <div className="text-center">
              ...
              <h2 className="mb-3 text-2xl font-bold">Emergency SOS</h2>
              <p className="mb-6 text-muted-foreground leading-relaxed">
                This will immediately alert emergency services and your emergency contacts. Only use in case of a real
                emergency.
              </p>
              <div className="space-y-3">
