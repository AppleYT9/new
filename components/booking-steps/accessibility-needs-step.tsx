...
export function AccessibilityNeedsStep({ bookingData, updateBookingData }: AccessibilityNeedsStepProps) {
  ...
  return (
    <div>
      <h2 className="mb-2 text-2xl font-bold text-balance">Accessibility Needs</h2>
      <p className="mb-8 text-muted-foreground leading-relaxed">
        Select any specific requirements for your ride (optional)
      </p>
      ...
      <div className="mt-6 rounded-xl bg-primary/5 p-4 border border-primary/20">
        <p className="text-sm text-foreground">
          <span className="font-medium">AI Matching:</span> Our system will automatically match you with the most
          suitable vehicle based on your selections
        </p>
      </div>
    </div>
  )
