...
export function RideCategoryStep({ bookingData, updateBookingData }: RideCategoryStepProps) {
  ...
  return (
    <div>
      <h2 className="mb-2 text-2xl font-bold text-balance">Select Ride Category</h2>
      <p className="mb-8 text-muted-foreground leading-relaxed">Choose the type of ride that best fits your needs</p>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="mb-1 font-semibold text-balance">{category.title}</h3>
