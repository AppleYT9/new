...
export function SafetyPreferencesStep({ bookingData, updateBookingData }: SafetyPreferencesStepProps) {
    ...
    return (
        <div>
            <h2 className="mb-2 text-2xl font-bold text-balance"><TranslatedText text="Safety Preferences" /></h2>
            <p className="mb-8 text-muted-foreground leading-relaxed"><TranslatedText text="Customize your safety settings (optional)" /></p>
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <Label htmlFor={pref.id} className="font-medium cursor-pointer">
                                    <TranslatedText text={pref.label} />
                                </Label>
                                <p className="text-sm text-muted-foreground mt-1"><TranslatedText text={pref.description} /></p>
                            </div>
                            <Switch
                                id={pref.id}
            ...
            <div className="mt-6 rounded-xl bg-accent/5 p-6 border border-accent/20">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="font-semibold mb-1"><TranslatedText text="Your Safety Matters" /></h3>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                            <TranslatedText text="All rides include GPS tracking, verified drivers, and 24/7 support. SOS panic button available throughout your journey." />
                        </p>
                    </div>
                </div>
            </div>
