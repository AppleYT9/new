...
export function LocationStep({ bookingData, updateBookingData }: LocationStepProps) {
  return (
    <div>
      <h2 className="mb-2 text-2xl font-bold text-balance">Pickup & Drop-off Locations</h2>
      <p className="mb-8 text-muted-foreground leading-relaxed">Enter your journey details</p>
        ...
        <div className="rounded-xl bg-muted p-4">
          <div className="aspect-video bg-background rounded-lg flex items-center justify-center border border-border">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Map interface would display here</p>
            </div>
          </div>
        </div>
